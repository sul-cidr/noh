...
<main class="page-content">
  <div class="text-container">
    ...
    <p>This is one of the most common patterns. It does not have a specific time or spatial points within a dance. Because of its ‘retreat’ motion (three back steps), it is most of the time preceded by a forward pattern such as the <a href="/movement/forward-point/" target="_blank">Forward Point</a> (<em>shikake</em>), <a href="/movement/scooping-point/" target="_blank">Scooping Point</a> (<em>kaikomi</em>), or a <a href="/movement/large-zigzag/" target="_blank">Large Zigzag</a> (<em>ōzayu</em>), among others. Originally, the pointing pattern aimed at identifying an object to be contemplated and the Open-retreat as a stepping back motion to better position oneself before contemplating the identified object. In this video, it is preceded by the Forward Point pattern (<em>shikake</em>).</p>
