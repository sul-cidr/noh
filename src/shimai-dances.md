  ...
  <div class="text-container">
    ...
    <div class="tabs-container">
      ...
      <div class="tabs-container__content">
        ...
        <h4>Shimai and Maibayashi<4>

        <p>In Noh, besides a play there are two forms of dance called <em>shimai</em> and <em>maibayashi</em>.</p>

        <p>Dance-to-text <em>shōdan</em> such as the <em>kuse</em> and<em>kiri</em> can be performed independently from a play. This form of dance called <em>shimai</em> includes a jiutai usually composed of four members, but no <em>hayashi</em>. </p>

        <p> Instrumental dances can also be performed independently from a play. This form of dance called <em>maibayashi</em> includes a <em>hayashi</em> and a jiutai usually composed of about five members. </p>

        <p>The dancer is not masked and wears a crest-adorned kimono and <em>hakama</em> rather than a costume. Moreover, the fan used for such occasion is larger than the one used for a play. Also, it is handled differently by the members of the jiutai. Whereas they kneel with hands in the pocket as fans rest on the stage floor when inactive, they hold the fan upwards when singing in a play, but resting on their laps when singing in a <em>shimai</em> or <em>maibayashi</em>.</p>
...
<p><u>1st section</u></p>
<p>1. phrase: </p>
<p>9. Right Step pivot, Three Steps forward, Two steps backward, Mind Listening, Left Step pivot
...
<p>3rd phrase: </p>
<p>9. Stand up, Right Step pivot, Go to Square 3
...
<p>5th phrase: </p>
<p>2. Pivot on knee, Look at the flower on the fan, Stand-up, Large Zigzag,
4. Left pivot, Scooping  point, Open-retreat</p>

<p><u>3rd section</u></p>
<p>6th phrase: </p>
<p>4. Extended fan, Go to Square 3
...
<p>9. Right Step pivot, Renesting the fan, Left pivot, Backing point, go to Square 3 with extended fan
3. Take the corner with extended fan, Large Circle (3-5-8)
8. Small Zigzag, Closure scoop</p>


        {% include video-no-background.html
          src="http://d7rcwrflqckpu.cloudfront.net/Dance_sl/Hashitomi_Kuse_Dance_Front_Score_sl.mp4"
        %}
        <h4 id="Hashitomi-Kuse-Side">Hashitomi Kuse Side</h4>

        {% include video-no-background.html
          src="http://d7rcwrflqckpu.cloudfront.net/Dance_sl/KHashitomi_Kuse_Dance_Side_Score_sl.mp4"
        %}
        ...
        <p><u>Opening sequence</u></p>
<p>8. Kneeling – Stand-up, Medium Zigzag
9. Scooping point, Open-retreat</p>

<p>1st phrase:</p>
<p>9.Left pivot to face the waki, Right pivot to continue the dance
9. Six steps towards Square 4
4. Right Step pivot, Two Steps forward, Left Circlet, Forward pointing, Cloud fan</p>

<p>2nd phrase:</p>
<p>4. Right Step pivot, Right Circle to Square 9
9. Right Step Pivot, Go to Square 3
3.Take the corner, Circle to Square 5
5. Make angle, Forward pointing, Open-retreat</p>

<p>3rd phrase:</p>
<p>5. Go to  Square 9, Right Simple pivot to Square 8
...
<p>8. Renesting the fan, Stand up, Closure scoop, Kneeling</p>
        ...
        {% include video-no-background.html
          src="http://d7rcwrflqckpu.cloudfront.net/Dance_sl/Hashitomi_Kiri_Dance_Front_Score_sl.mp4"
        %}
        <h4 id="Hashitomi-Kiri-Side">Hashitomi Kiri Side</h4>

        {% include video-no-background.html
          src="http://d7rcwrflqckpu.cloudfront.net/Dance_sl/Hashitomi_Kiri_Dance_Side_Score_sl.mp4"
        %}
        </section>
...
<p>8. Kneeling, Slide facing Square 5, Slide back, Slide to the Right, Grab the forelock, Raise on knee, Gaze in the distance, R-L-R head motion
8. Sit back on knee, Look down, Look straight ahead, Rise on knee
...
<p><u>2nd Section</u></p>
<p>2nd Phrase: </p>
<p>4. Four stamps, Open fan, Circle to Square 8
8. Scooping point, Ten steps to Square 4
4. Right Circlet, Open-retreat</p>

<p>3rd Phrase: </p>
<p>4. Go to Square 3, Head motion L-R-L
3. Kneel, Point toward Bridge</p>

<p>4th Phrase: </p>
<p>3. Stand, Left Circle</p>
5. Scooping point, Right stamp, Open-retreat</p>

<p><u>Closing sequence</u></p>
<p>5th Phrase: </p>
<p>5. Right Circle (5-2-8), Close fan, Sweeping point</p>
8. Scooping point, Open-retreat</p>

<p>6th Phrase: </p>
<p>8. Turn towards Square 5, Take three steps
9. Circlet, Go to Square 1
1. Left turn, Scooping point, Nine steps towards Square 5
9. Open-retreat</p>
...
8. Closure scoop, Kneel</p>
      ...
      <p><u>Opening sequence</u></p>
      <p>8. Kneeling – Stand-up, Go to Square 4
      4. Kneel, Use fan as a hammer, Hold fan with extended arms, Stand up, Right Full Circlet</p>

      <p>1st Phrase: </p>
      <p>4. Large Circle (4-2-8), Forward pointing, Right pivot, Go to Square 3
      3. Sway the fan, Open-retreat, Look at the fan, L-R-L Head motion</p>

      <p>2nd Phrase: </p>
      <p>3. Six-Seven Stamps & Head-turns LRL
      3. Double sweep, Right Circle (4-2-1)
      1. Body turn, Scooping point, Forward pointing, Open-retreat</p>

      <p>3rd Phrase: </p>
      <p>1. Two-hand offering of the fan, Go to Square 5
      5. Kneel, Put away the fan, Stand up, Nine steps back
      9. Knell and Bow</p>

      <p><u>Closing sequence</u></p>
      <p>9. Go to Square 4</p>
      4. Right Circlet, Left Back jump, Double knelling, Go to Square 8
