  ...
  <div class="wrapper sidebar-contents">
    ...
    <section class="sidebar-contents__section">
      <div class="text-container">
        ...
        <p>
          Metaphorically and literally, ‘breath’ is one of the primary unifying
        ...
        <p>
          ...
          the strokes and
          <em>kakegoe</em> of the ōtsuzumi, actors do not need to follow the the
        ...
        <p>
          ...
          or waki, and then repeated. If the jiutai repeats the text, it implies
          that it took over the communication of the thoughts of the character.
        </p>
        <p>
