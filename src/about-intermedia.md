...
<p>The chapter below is devoted to the general characteristics of Noh as intermedia. It represents the top-down view that seeks intermedia attributes of the entire plays and repoertoire overall. In other parts of the website, it is complemented by analytical views that focus on intermedia relationships on different levels of the form, gradually 'zooming in' on intermedia flow of the individual plays, acts, <em>dan</em> and <em>shōdan</em>. To support the discovery of intermedia in Noh in a bottom-up view, we offer also <a href="/elements/" target="_blank">introductions</a> to individual layers and their building blocks. </p>

<p>
To fully appreciate intermedia workings in Noh it is very helpful to be able to anticipate and follow its form. The structure of development is highly codified in Noh so an informed viewer can recognize its consequitive sections even within an unfamiliar play. To help our readers orient themselves and build these useful expectations, we have developed visual representations of each play’s structure using an <a href="/form/#ITI">Intermedia Texture Index</a> (ITI).  Its formula integrates information from multiple layers into a <a href="/hashitomi">single graph</a>, which is intentionally reductive.  To ground the viewers’ expectations in a more detailed way, the website offers also intermedia <a href="/hashitomi/ageuta-1/">‘scores’</a> by sections (<em>shōdan</em>). The viewers can see there notation for a set of intermedia layers, or make a selection among them to shift focus according to need.</p>
<p>
...
<p>
Secondly, the interactivity or non-linearity of presentation gives the intermedia material a chance to be explored from multiple angles and with different depth that matches the needs of the reader and leaves more space for their own interpretation. For example, it is possibile for a dance-focused reader to start by chapters about traditional dance elements in Noh or customize the score of a particular dance <em>shōdan</em> to feature information about its sequence <em>kata</em>. We are aware also that analysis of intermedia is extremely time consuming. Just to discuss the impact of music, one could address fluctuations in tempo, rhythmic organization, pitch motion and range, styles of delivery and more. Accounting for all expressive dimensions in all media and analyzing the complete network of intermedia relationships is prohibitively complex and perhaps impossible. Interactivity enables therefore exploration of Noh as intermedia in a more intuitive and personal way that fits the experience and interest of the readers. </p>
