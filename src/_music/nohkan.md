...
<h3 id="Patterns">Melodic Patterns</h3>
    <p>The role of the Nohkan is to create an ambiance that reflects the particular emotions of the play, the status or psychological mindset of a character in a given section, as well as to underline the dramatic structure. This is achieved using a collection of nearly a hundred melodic patterns that are shared between different plays with X number of them ocurring in majority of plays. In performance, the same patterns are inflected with expressive characteristics that serve the demands of a specific play, section and strucutral moment. </p><p>
